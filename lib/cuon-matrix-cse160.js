...
class Vector3 {
    ...
    static cross(other1, other2) {
        // Insert your code here.
        var i = other1.elements[1] * other2.elements[2] - other2.elements[1] * other1.elements[2];
        // console.log(i);
        var j = (other2.elements[0] * other1.elements[2] - other1.elements[0] * other2.elements[2]);
        // console.log(j);
        var k = other1.elements[0] * other2.elements[1] - other2.elements[0] * other1.elements[1];
        // console.log(k);

        // This function should create and return a new vector.
        var v3 = new Vector3([i, j, k]); // Modify this line to calculate cross product between other1 and other2.
        // console.log(v3);
        // Don't delete the return statement.
        return v3;
    }
